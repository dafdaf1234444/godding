...
| Epistemological finding | Swarm implication | Status |
|-------------------------|-------------------|--------|
| Justified true belief requires process reliability | Tool reliability directly affects knowledge quality | THEORIZED |
| Forgetting is epistemically functional (not just loss) | DECAYED state may be healthy pruning, not pathology | THEORIZED |
| Social testimony requires trust calibration | Steerer signals need epistemic weight, not equal voice | THEORIZED |
...
## Epistemology links to current principles
PHIL-22 (theorem self-application) | P-182 (expect-act-diff) | P-243 (science quality)
